...
export default function DownloadPage() {
  ...
  const handleDownloadRequest = (url: string, external: boolean) => {
    setPendingUrl(url);
    setIsExternalWindow(external);
      ...
      <main className="pt-32 pb-32 px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-4xl md:text-6xl font-black mb-6 italic uppercase font-light">
            ...
            >
              ...
              <div className="relative h-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-pink-500/30 rounded-[2.5rem] p-8 flex flex-col items-center">
                <div className="bg-pink-500/20 p-4 rounded-full mb-6 relative">
                  <div className="absolute inset-0 bg-pink-500 motion-safe:animate-ping opacity-20 rounded-full"></div>
                  <Crown className="w-10 h-10 text-pink-400 relative z-10" aria-hidden="true" />
                </div>

                <h3 className="text-2xl font-bold mb-2">Testeur Officiel</h3>
                ...
                <button
                  onClick={() => handleDownloadRequest("https://appdistribution.firebase.dev/i/5b0688df7242f396", false)}
            ...
            >
              <div className="h-full bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/20 rounded-[2.5rem] p-8 flex flex-col items-center transition-colors">
                <div className="bg-white/10 p-4 rounded-full mb-6">
                  <Download className="w-10 h-10 text-gray-400" aria-hidden="true" />
                </div>
                ...
                <button
                  onClick={() => handleDownloadRequest("/api/download-apk", true)}
                ...
                <div className="flex items-start gap-3 text-left bg-black/20 p-4 rounded-xl text-xs text-gray-400 w-full mt-auto">
                  <Info className="w-5 h-5 shrink-0 text-white/40 mt-0.5" aria-hidden="true" />
